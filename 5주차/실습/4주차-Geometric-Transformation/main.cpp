...
int main()
{
	...
	// 회전 동차 행렬을 정의한다.
	// geometry.cpp의 Geometry::SetRotateMatrix 함수를 구현하세요.
	double degree = -10.0;
	transformator.SetRotateMatrix(degree);

	// Q1. 전방 기하 변환을 정의한다.
	// geometry.cpp의 Geometry::ForwardTransformation 함수를 구현하세요.
	transformator.ForwardTransformation(original_image, forward_result_image);

	// Q2. 후방 기하 변환을 정의한다.
	// geometry.cpp의 Geometry::BackwardTransformation 함수를 구현하세요.
